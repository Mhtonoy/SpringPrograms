...
The `@Value` annotation in Spring is used to *inject values into Spring bean fields or methods*. `@Value` is mostly used to inject values from external sources (properties files of environment variables)
